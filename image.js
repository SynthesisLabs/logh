...
// async function createImage(song, artist, album, img, currentTime, songDuration, user) 

module.exports = class MusicCard {
    constructor() {
        this.username = 'uitgeteld';
        this.cover = `${__dirname}/../../Assets/default-avatar.png`;
    }
